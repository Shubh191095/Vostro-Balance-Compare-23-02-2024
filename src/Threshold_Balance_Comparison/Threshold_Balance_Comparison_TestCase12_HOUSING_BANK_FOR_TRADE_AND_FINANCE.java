...
public class Threshold_Balance_Comparison_TestCase12_HOUSING_BANK_FOR_TRADE_AND_FINANCE  {
...
//==========================================================================================================================================================         
       //Get text and compare with properties file
         ...
         pw.println("Vostro Balance JOD: " + vostroBalance);
         pw.println(properties.getProperty("HBTF-JOD"));
