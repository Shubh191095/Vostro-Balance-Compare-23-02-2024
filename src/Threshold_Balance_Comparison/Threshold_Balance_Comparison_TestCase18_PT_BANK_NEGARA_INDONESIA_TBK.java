...
public class Threshold_Balance_Comparison_TestCase18_PT_BANK_NEGARA_INDONESIA_TBK {
...
//==========================================================================================================================================================         
	         ...
	         pw.println(properties.getProperty("BNI-USD"));
	         pw.println(properties.getProperty("BNI-IDR"));
	        ...
	        //For USD Currency		
	 		if(Double.valueOf(vostroBalanceUSD)  < Double.valueOf(properties.getProperty("BNI-IDR"))) {
	 			 ...
	 			 pw.println("BALANCE IS BELOW THRESHOLD BALANCE");
	 		}else if(Double.valueOf(properties.getProperty("BPI-USD")) <  Double.valueOf(vostroBalanceUSD) && Double.valueOf(vostroBalanceUSD)  < Double.valueOf(properties.getProperty("BNI_Near_To_Threshold_Balance"))) {
	 			 pw.println("REACHING NEAR TO THRESHOLD BALANCE PLEASE ADD BALANCE");
	 		}else {
