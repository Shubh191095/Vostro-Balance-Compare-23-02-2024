...
public class Threshold_Balance_Comparison_TestCase06_Bank_Central_Asia {
...
//==========================================================================================================================================================         
	         ...
	         String vostroBalanceIDR=elementPHP.getText().replace(",", "");
	         ...
	         pw.println(properties.getProperty("BCA-IDR"));
	         pw.println(properties.getProperty("BCS-USD"));
	        ...
	        //For PHP Currency
	 		...
	 		}else if(Double.valueOf(properties.getProperty("BCS-IDR")) <  Double.valueOf(vostroBalanceIDR) && Double.valueOf(vostroBalanceIDR)  < Double.valueOf(properties.getProperty("BCA_Near_To_Threshold_Balance"))) {
