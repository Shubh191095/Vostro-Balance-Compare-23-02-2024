...
public class UBL_United_Bank_Limited {
	public void testBase026(WebDriver driver) throws InterruptedException, IOException
	{
...
//=====================================================================================================================================		
			...
			driver.findElement(By.xpath("/html/body/div/div[1]/div/div/div/section/div/div/div/div[2]/div/div[1]/select/option[42]")).click();
			Thread.sleep(2000);
...
//===================================================================================================================================================       
			   ...
			   //Take Screen Shots for Select the Partner
				    ...
				    Files.copy(f6, new File("C:\\Users\\Shubham\\Desktop\\New Automation Project Related Docs\\Automation Screenshots\\Vostro Balance For UBL_United_Bank_Limited.jpg"));
...
//==========================================================================================================================================================         
	         ...
	         pw.println("Vostro Balance UBL-PKR: " + vostroBalance);
			  
			 pw.println("Threshold Balance For UBL-PKR: "+properties.getProperty("UBL-PKR"));

	         if(Double.valueOf(vostroBalance)  < Double.valueOf(properties.getProperty("UBL-PKR"))) {

	          pw.println("BALANCE IS BELOW THRESHOLD BALANCE FOR UBL-PKR CURRENCY");
	         }else if(Double.valueOf(properties.getProperty("UBL-PKR")) <  Double.valueOf(vostroBalance) && Double.valueOf(vostroBalance)  < Double.valueOf(properties.getProperty("UBL_Near_To_Threshold_Balance"))) {
	          pw.println("REACHING NEAR TO THRESHOLD BALANCE PLEASE ADD BALANCE FOR UBL-PKR CURRENCY");
	         }else {
	          pw.println("BALANCE IS SUFFICIENT FOR UBL-PKR CURRENCY");
	         }
	        // Thread.sleep(2000);
	         pw.println("*****Test Case 026 Passed For UBL_United_Bank_Limited*****");
	         pw.println(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>");
	         pw.close();
	         }}