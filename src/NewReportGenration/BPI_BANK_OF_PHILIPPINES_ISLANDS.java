...
public class BPI_BANK_OF_PHILIPPINES_ISLANDS {
	public void testBase005(WebDriver driver) throws InterruptedException, IOException
	{
...
//=====================================================================================================================================		
	  			...
	  			driver.findElement(By.xpath("/html/body/div/div[1]/div/div/div/section/div/div/div/div[2]/div/div[1]/select/option[11]")).click();
	  			Thread.sleep(2000);
...
//===================================================================================================================================================     
				   ...
				   //Take Screen Shots for Select the Partner
					    ...
					    Files.copy(f6, new File("C:\\Users\\Shubham\\Desktop\\New Automation Project Related Docs\\Automation Screenshots\\Vostro Balance For (BPI)BANK_OF_PHILIPPINES_ISLANDS.jpg"));
...
//==========================================================================================================================================================         
	  	         ...
	  	         pw.println("Threshold Balance For BPI-PHP "+properties.getProperty("BPI-PHP"));
	  	         pw.println("Threshold Balance For BPI-USD "+properties.getProperty("BPI-USD"));
	  	         	  	         
	  	        //For PHP Currency
	  	 		if(Double.valueOf(vostroBalancePHP)  < Double.valueOf(properties.getProperty("BPI-PHP"))) {
	                pw.println("BALANCE IS BELOW THRESHOLD BALANCE FOR BPI-PHP CURRENCY");
	  	 		}else if(Double.valueOf(properties.getProperty("BPI-PHP")) <  Double.valueOf(vostroBalancePHP) && Double.valueOf(vostroBalancePHP)  < Double.valueOf(properties.getProperty("BPI_Near_To_Threshold_Balance"))) {
	  	 			pw.println("REACHING NEAR TO THRESHOLD BALANCE PLEASE ADD BALANCE FOR BPI-PHP CURRENCY");
	  	 		}else {
	  	 			pw.println("BALANCE IS SUFFICIENT FOR BPI-PHP CURRENCY");
	  	 		}
	  	 		//Thread.sleep(2000);
	  	 		
	  	        //For USD Currency		
	  	 		if(Double.valueOf(vostroBalanceUSD)  < Double.valueOf(properties.getProperty("BPI-USD"))) {

	  	 			pw.println("BALANCE IS BELOW THRESHOLD BALANCE BPI-USD CURRENCY");
	  	 		}else if(Double.valueOf(properties.getProperty("BPI-USD")) <  Double.valueOf(vostroBalanceUSD) && Double.valueOf(vostroBalanceUSD)  < Double.valueOf(properties.getProperty("BPI_Near_To_Threshold_Balance"))) {
	  	 			pw.println("REACHING NEAR TO THRESHOLD BALANCE PLEASE ADD BALANCE BPI-USD CURRENCY");
	  	 		}else {
	  	 			pw.println("BALANCE IS SUFFICIENT FOR BPI-USD CURRENCY BPI-USD CURRENCY");
	  	 		}
	  	 		//Thread.sleep(2000);
	  	 	     pw.println("*****Test Case 005 Passed For BPI_BANK_OF_PHILIPPINES_ISLANDS*****");
	  	 	     pw.println(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>");
	  	 	     pw.close();
	  	 		}}
