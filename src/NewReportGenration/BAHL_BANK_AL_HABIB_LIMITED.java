...
public class BAHL_BANK_AL_HABIB_LIMITED {
	public void testBase004(WebDriver driver) throws InterruptedException, IOException
	{
...
//===================================================================================================================================================     
			   ...
			   //Take Screen Shots for Select the Partner
				    ...
				    Files.copy(f6, new File("C:\\Users\\Shubham\\Desktop\\New Automation Project Related Docs\\Automation Screenshots\\Vostro Balance For BAHL(BANK_AL_HABIB_LIMITED).jpg"));
...
//==========================================================================================================================================================         
	       //Get text and compare with properties file
	         ...
	         pw.println("Vostro Balance BAHL-PKR: " + vostroBalance);
			  
			 pw.println("Threshold Balance For BAHL-PKR: "+properties.getProperty("BAHL-PKR"));

	         if(Double.valueOf(vostroBalance)  < Double.valueOf(properties.getProperty("BAHL-PKR"))) {

	        	 pw.println("BALANCE IS BELOW THRESHOLD BALANCE FOR BAHL-PKR CURRENCY");
	        	 ...
	        	 pw.println("REACHING NEAR TO THRESHOLD BALANCE PLEASE ADD BALANCE FOR BAHL-PKR CURRENCY");
	         }else {
	         	pw.println("BALANCE IS SUFFICIENT FOR BAHL-PKR CURRENCY");
	         }
	         //Thread.sleep(2000);
	         pw.println("*****Test Case 004 Passed For BAHL_BANK_AL_HABIB_LIMITED*****");
	         pw.println(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>");
	         pw.close();
	         }}
