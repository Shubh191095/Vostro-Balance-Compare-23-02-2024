...
public class BRI_Bank_Rakyat_Indonesia {
	public void testBase008(WebDriver driver) throws InterruptedException, IOException
	{
...
//=====================================================================================================================================		
			...
			driver.findElement(By.xpath("/html/body/div/div[1]/div/div/div/section/div/div/div/div[2]/div/div[1]/select/option[12]")).click();
			Thread.sleep(2000);
...
//===================================================================================================================================================     
	      //6: Accept the Pop_Up	  
			   ...
			   //Take Screen Shots for Select the Partner
				    ...
				    Files.copy(f6, new File("C:\\Users\\Shubham\\Desktop\\New Automation Project Related Docs\\Automation Screenshots\\Vostro Balance For (BRI)Bank_Rakyat_Indonesia.jpg"));
...
//==========================================================================================================================================================         
	       //Get text and compare with properties file
	         ...
	         pw.println("Vostro Balance IDR: " + vostroBalance);
	    	 pw.println("Threshold Balance For BRI-IDR: "+properties.getProperty("BRI-IDR"));

	         if(Double.valueOf(vostroBalance)  < Double.valueOf(properties.getProperty("BRI-IDR"))) {

	        	 pw.println("BALANCE IS BELOW THRESHOLD BALANCE FOR BRI-IDR CURRENCY");
	        	 ...
	        	 pw.println("REACHING NEAR TO THRESHOLD BALANCE PLEASE ADD BALANCE FOR BRI-IDR CURRENCY");
	         }else {
	        	 pw.println("BALANCE IS SUFFICIENT FOR BRI-IDR CURRENCY");
	         }
	         //Thread.sleep(2000);
	         pw.println("*****Test Case 008 Passed For BRI_Bank_Rakyat_Indonesia*****");
	         pw.println(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>");
	         pw.close();
	         }}