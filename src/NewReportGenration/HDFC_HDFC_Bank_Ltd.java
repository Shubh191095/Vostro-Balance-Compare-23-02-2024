...
public class HDFC_HDFC_Bank_Ltd {
	public void testBase011(WebDriver driver) throws InterruptedException, IOException
	{
...
//=====================================================================================================================================		
			...
			driver.findElement(By.xpath("/html/body/div/div[1]/div/div/div/section/div/div/div/div[2]/div/div[1]/select/option[21]")).click();
			Thread.sleep(2000);
...
//===================================================================================================================================================     
			   ...
			   //Take Screen Shots for Select the Partner
				    ...
				    Files.copy(f6, new File("C:\\Users\\Shubham\\Desktop\\New Automation Project Related Docs\\Automation Screenshots\\Vostro Balance For (HDFC)HDFC_Bank_Ltd.jpg"));
...
//==========================================================================================================================================================         
	       //Get text and compare with properties file
	         ...
	         pw.println("Threshold Balance For HDFC-INR: "+properties.getProperty("HDFC-INR"));

	         if(Double.valueOf(vostroBalance)  < Double.valueOf(properties.getProperty("HDFC-INR"))) {
	         pw.println("BALANCE IS BELOW THRESHOLD BALANCE FOR HDFC-INR CURRENCY");
	        	 ...
	        	 pw.println("REACHING NEAR TO THRESHOLD BALANCE PLEASE ADD BALANCE FOR HDFC-INR CURRENCY");
	         }else {
	        	 pw.println("BALANCE IS SUFFICIENT FOR HDFC-INR CURRENCY");
	         }
	        // Thread.sleep(2000);
	         pw.println("*****Test Case 011 Passed For HDFC_HDFC_Bank_Ltd*****");
	         pw.println(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>");
	         pw.close();
	         }}