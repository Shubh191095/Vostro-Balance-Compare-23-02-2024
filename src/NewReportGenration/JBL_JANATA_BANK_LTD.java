...
public class JBL_JANATA_BANK_LTD {
	public void testBase015(WebDriver driver) throws InterruptedException, IOException
	{
...
//=====================================================================================================================================		
			...
			driver.findElement(By.xpath("/html/body/div/div[1]/div/div/div/section/div/div/div/div[2]/div/div[1]/select/option[26]")).click();
			Thread.sleep(2000);
...
//===================================================================================================================================================     
		   ...
		   //Take Screen Shots for Select the Partner
			    ...
			    Files.copy(f6, new File("C:\\Users\\Shubham\\Desktop\\New Automation Project Related Docs\\Automation Screenshots\\Vostro Balance For (JBL)JANATA_BANK_LTD.jpg"));
...
//==========================================================================================================================================================         
	         ...
	         pw.println("Threshold Balance For JBL-BDT: "+properties.getProperty("JBL-BDT"));

	         if(Double.valueOf(vostroBalance)  < Double.valueOf(properties.getProperty("JBL-BDT"))) {

	        	 pw.println("BALANCE IS BELOW THRESHOLD BALANCE FOR JBL-BDT CURRENCY");
	         }else if(Double.valueOf(properties.getProperty("JBL-BDT")) <  Double.valueOf(vostroBalance) && Double.valueOf(vostroBalance)  < Double.valueOf(properties.getProperty("JBL-Near_To_Threshold_Balance"))) {
	        	 pw.println("REACHING NEAR TO THRESHOLD BALANCE PLEASE ADD BALANCE FOR JBL-BDT CURRENCY");
	         }else {
	        	 pw.println("BALANCE IS SUFFICIENT FOR JBL-BDT CURRENCY");
	         }
	         //Thread.sleep(2000);
	         pw.println("*****Test 015 Case Passed For JBL_JANATA_BANK_LTD*****");
	         pw.println(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>");
	         pw.close();
	         }}