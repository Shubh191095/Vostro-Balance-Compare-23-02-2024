...
public class SBL_SONALI_BANK_LTD {
	public void testBase022(WebDriver driver) throws InterruptedException, IOException
	{
...
//=====================================================================================================================================		
			...
			driver.findElement(By.xpath("/html/body/div/div[1]/div/div/div/section/div/div/div/div[2]/div/div[1]/select/option[37]")).click();
			Thread.sleep(2000);
...
//===================================================================================================================================================             
			   ...
			   //Identify the pop-up element using XPath (adjust the XPath as needed)
			     ...
			     okButton.click();
				    ...
				    Files.copy(f6, new File("C:\\Users\\Shubham\\Desktop\\New Automation Project Related Docs\\Automation Screenshots\\Vostro Balance For (SBL)SONALI_BANK_LTD.jpg"));
...
//==========================================================================================================================================================         
	         ...
	         pw.println("Vostro Balance SBL-BDT: " + vostroBalance);
			  
			 pw.println("Threshold Balance For SBL-BDT: "+properties.getProperty("SBL-BDT"));

	         if(Double.valueOf(vostroBalance)  < Double.valueOf(properties.getProperty("SBL-BDT"))) {

	         pw.println("BALANCE IS BELOW THRESHOLD BALANCE FOR SBL-BDT CURRENCY");
	         }else if(Double.valueOf(properties.getProperty("SBL-BDT")) <  Double.valueOf(vostroBalance) && Double.valueOf(vostroBalance)  < Double.valueOf(properties.getProperty("SBL_Near_To_Threshold_Balance"))) {
	        	 pw.println("REACHING NEAR TO THRESHOLD BALANCE PLEASE ADD BALANCE FOR SBL-BDT CURRENCY");
	         }else {
	        	 pw.println("BALANCE IS SUFFICIENT FOR SBL-BDT CURRENCY");
	         }
	         //Thread.sleep(2000);
	         pw.println("*****Test Case 022 Passed For SBL_SONALI_BANK_LTD*****");
	         pw.println(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>");
	         pw.close();
	         }}