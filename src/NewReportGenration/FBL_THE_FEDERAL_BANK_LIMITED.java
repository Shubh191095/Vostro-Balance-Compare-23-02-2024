...
public class FBL_THE_FEDERAL_BANK_LIMITED {
	public void testBase025(WebDriver driver) throws InterruptedException, IOException
	{
...
//=====================================================================================================================================		
			...
			driver.findElement(By.xpath("/html/body/div/div[1]/div/div/div/section/div/div/div/div[2]/div/div[1]/select/option[41]")).click();
			Thread.sleep(2000);
...
//===================================================================================================================================================     	        
			   ...
			   //Identify the pop-up element using XPath (adjust the XPath as needed)
			     ...
			     //Take Screen Shots for Select the Partner
				    ...
				    Files.copy(f6, new File("C:\\Users\\Shubham\\Desktop\\New Automation Project Related Docs\\Automation Screenshots\\Vostro Balance For (FBL)THE_FEDERAL_BANK_LIMITED.jpg"));
...
//==========================================================================================================================================================         
	         ...
	         pw.println("Vostro Balance INR: " + vostroBalance);
	    	 pw.println("Threshold Balance For FBL-INR: "+properties.getProperty("FBL-INR"));

	         if(Double.valueOf(vostroBalance)  < Double.valueOf(properties.getProperty("FBL-INR"))) {

	        	pw.println("BALANCE IS BELOW THRESHOLD BALANCE FOR FBL-INR CURRENCY");
	         }else if(Double.valueOf(properties.getProperty("FBL-INR")) <  Double.valueOf(vostroBalance) && Double.valueOf(vostroBalance)  < Double.valueOf(properties.getProperty("FBL_Near_To_Threshold_Balance"))) {
	        	pw.println("REACHING NEAR TO THRESHOLD BALANCE PLEASE ADD BALANCE FOR FBL-INR CURRENCY");
	         }else {
	        	pw.println("BALANCE IS SUFFICIENT FOR FBL-INR CURRENCY");
	         }
	         //Thread.sleep(2000);
	         pw.println("*****Test Case 025 Passed For FBL_THE_FEDERAL_BANK_LIMITED*****");
	         pw.println(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>");
	         pw.close();
	         }}