...
public class BNI_PT_BANK_NEGARA_INDONESIA_TBK {
	public void testBase018(WebDriver driver) throws InterruptedException, IOException
	{
...
//=====================================================================================================================================		
	  			...
	  			driver.findElement(By.xpath("/html/body/div/div[1]/div/div/div/section/div/div/div/div[2]/div/div[1]/select/option[34]")).click();
	  			Thread.sleep(2000);
...
//===================================================================================================================================================     
	  	    ...
	  	    //6: Select the Pop_Up 1 USD	  
				   ...
				   //Take Screen Shots for Select the Partner
					    ...
					    Files.copy(f6, new File("C:\\Users\\Shubham\\Desktop\\New Automation Project Related Docs\\Automation Screenshots\\Vostro Balance For (BNI)PT_BANK_NEGARA_INDONESIA_TBK.jpg"));
					    pw.println ("User is able to click on Accept the Pop_Up");
//=======================================================================================================================================		
	  	        //7: Click on the refresh Button
	  	        //For INR Currency
	  	      	driver.findElement(By.xpath("/html/body/div[1]/div[1]/div/div/div/section/div/div/div/div[2]/div/table/tbody/tr[2]/td[6]/a")).click();
	  	      	Thread.sleep(60000);
...
//==========================================================================================================================================================         
	  	         ...
	  	         pw.println("Vostro Balance USD: " + vostroBalancePHP);
	  	         pw.println("Vostro Balance IDR: " + vostroBalanceUSD);
	  	         
	  	         pw.println("Threshold Balance For BNI-USD: "+properties.getProperty("BNI-USD"));
		    	 pw.println("Threshold Balance For BNI-IDR: "+properties.getProperty("BNI-IDR"));
	  	  
	  	        //For PHP Currency
	  	 		if(Double.valueOf(vostroBalancePHP)  < Double.valueOf(properties.getProperty("BNI-USD"))) {

	  	 			 pw.println("BALANCE IS BELOW THRESHOLD BALANCE FOR BNI-USD CURRENCY");
	  	 		}else if(Double.valueOf(properties.getProperty("BNI-USD")) <  Double.valueOf(vostroBalancePHP) && Double.valueOf(vostroBalancePHP)  < Double.valueOf(properties.getProperty("BNI_Near_To_Threshold_Balance"))) {
	  	 			 pw.println("REACHING NEAR TO THRESHOLD BALANCE PLEASE ADD BALANCE FOR BNI-USD CURRENCY");
	  	 		}else {
	  	 			 pw.println("BALANCE IS SUFFICIENT FOR BNI-USD CURRENCY");
	  	 		}
	  	 		//Thread.sleep(2000);
	  	 		
	  	        //For USD Currency		
	  	 		if(Double.valueOf(vostroBalanceUSD)  < Double.valueOf(properties.getProperty("BNI-IDR"))) {

	  	 			 pw.println("BALANCE IS BELOW THRESHOLD BALANCE FOR BNI-IDR CURRENCY");
	  	 		}else if(Double.valueOf(properties.getProperty("BNI-IDR")) <  Double.valueOf(vostroBalanceUSD) && Double.valueOf(vostroBalanceUSD)  < Double.valueOf(properties.getProperty("BNI_Near_To_Threshold_Balance"))) {
	  	 			 pw.println("REACHING NEAR TO THRESHOLD BALANCE PLEASE ADD BALANCE FOR BNI-IDR CURRENCY");
	  	 		}else {
	  	 			 pw.println("BALANCE IS SUFFICIENT FOR BNI-IDR CURRENCY");
	  	 		}
	  	 		//Thread.sleep(2000);
	  	 	    pw.println("*****Test Case Passed For BNI_PT_BANK_NEGARA_INDONESIA_TBK*****");
	  	 	 pw.println(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>");
	  	 	    pw.close();
	  	 		}}
