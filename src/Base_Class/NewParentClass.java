...
//=============================================================================================================================================================================
//MID  //#REAL DATA PLS CHANGE AFTER TESTING       500000   600000
	...
	public void testABLPAK() throws InterruptedException, IOException {
		...
		FileInputStream file = new FileInputStream(filePath); properties.load(file);
		...
		do {			
			try {
				...
				assistant.VostroCheckCompare(driver,partnerName,ablPakXpath,ablPakThreshold,ablPakNearThreshold);
				System.out.println("1:==========*****TEST CASE FOR ABLPAK PASSED*****==========");
				i1=1;
...
//v.SLOW  //#2:AUB_ASIA_UNITED_BANK                      
	...
	public void testAUB() throws InterruptedException, IOException {
		...
		String AUB_NEAR_TO_THRESHOLD=properties.getProperty("AUB_Near_To_Threshold_Balance");
		Assistant assistant=new Assistant();
		do {
			try {
				counter++;
				System.out.println("Counter= "+ counter);
				System.out.println("Value of i1= "+ i1);
				assistant.VostroCheckCompare2Currency(driver,partnerName111,partnerName211, AUB_XPATH, AUB_thres_usd, AUB_thres_php, AUB_NEAR_TO_THRESHOLD);
...
//===========================================================================================================================================
//FAST  //###REAL DATA PLS CHANGE AFTER TESTING        #5000000   5500000
	...
	public void testAJWB() throws InterruptedException, IOException {
		...
		do {			
			try {
				counter++;
				assistant.VostroCheckCompare(driver,partnerName,AJWB_XPATH,AJWB_thres,AJWB_Near_thres);
...
//================================================================================================================================================    
//FAST  //#4:BAHL_BANK_AL_HABIB_LIMITED                               
	...
	public void testBAHL() throws InterruptedException, IOException {
		...
		do {			
			try {
				...
				System.out.println("Counter= "+ counter);
				System.out.println("Value of i1= "+ i1);
				assistant.VostroCheckCompare(driver,partnerName,BAHL_XPATH,BAHL_thres,BAHL_Near_thres);
...
//=========================================================================================================================================    
//MID  //#5:BPI_BANK_OF_PHILIPPINES_ISLANDS          
	...
	public void testBPI() throws InterruptedException, IOException {
		...
		String BPI_NEAR_TO_THRESHOLD=properties.getProperty("BPI_Near_To_Threshold_Balance");
		Assistant assistant=new Assistant();
		do {
			try {
				counter++;
				System.out.println("Counter= "+ counter);
				System.out.println("Value of i1= "+ i1);
				assistant.VostroCheckCompare2Currency(driver,partnerName111,partnerName211, BPI_XPATH, BPI_thres_usd, BPI_thres_php, BPI_NEAR_TO_THRESHOLD);
...
//================================================================================================================================================    
//FAST  //#6:BCA_BCA_Bank_Central_Asia             
	...
	public void testBCA() throws InterruptedException, IOException {
		...
		String BCA_NEAR_TO_THRESHOLD=properties.getProperty("BCA_Near_To_Threshold_Balance");
		Assistant assistant=new Assistant();
		do {
			try {
				counter++;
				System.out.println("Counter= "+ counter);
				System.out.println("Value of i1= "+ i1);
				assistant.VostroCheckCompare2Currency(driver,partnerName111,partnerName211, BCA_XPATH, BCA_thres_usd, BCA_thres_php, BCA_NEAR_TO_THRESHOLD);
...
//=========================================================================================================================================    
//V.SLOW  //#7:BDO_Banco_de_Oro_Unibank_Inc          
	...
	public void testBDO() throws InterruptedException, IOException {
		...
		String BDO_NEAR_TO_THRESHOLD=properties.getProperty("BDO_Near_To_Threshold_Balance");
		Assistant assistant=new Assistant();
		do {
			try {
				counter++;
				System.out.println("Counter= "+ counter);
				System.out.println("Value of i1= "+ i1);
				assistant.VostroCheckCompare2Currency(driver,partnerName111,partnerName211, BDO_XPATH, BDO_thres_usd, BDO_thres_php, BDO_NEAR_TO_THRESHOLD);
...
//===========================================================================================================================   
//FAST  //#8:BRI_Bank_Rakyat_Indonesia                             
	...
	public void testBRI() throws InterruptedException, IOException {
		...
		do {			
			try {
				...
				System.out.println("Counter= "+ counter);
				System.out.println("Value of i1= "+ i1);
				assistant.VostroCheckCompare(driver,partnerName,BRI_XPATH,BRI_thres,BRI_Near_thres);
...
//=========================================================================================================================================== 	
//FAST  //#9:GIBL_Global_IME_Bank_Ltd                           
	...
	public void testGIBL() throws InterruptedException, IOException {
		...
		do {			
			try {
				...
				System.out.println("Counter= "+ counter);
				System.out.println("Value of i1= "+ i1);
				assistant.VostroCheckCompare(driver,partnerName,GIBL_XPATH,GIBL_thres,GIBL_Near_thres);
	...
	public void testHABIB() throws InterruptedException, IOException {
		...
		do {			
			try {
				...
				System.out.println("Counter= "+ counter);
				System.out.println("Value of i1= "+ i1);
				assistant.VostroCheckCompare(driver,partnerName,HABIB_XPATH,HABIB_thres,HABIB_Near_thres);
	...
	public void testHDFC() throws InterruptedException, IOException {
		...
		do {			
			try {
				...
				System.out.println("Counter= "+ counter);
				System.out.println("Value of i1= "+ i1);
				assistant.VostroCheckCompare(driver,partnerName,HDFC_XPATH,HDFC_thres,HDFC_Near_thres);
...
//===========================================================================================================================        
//MID  //#12:HBTF_HOUSING_BANK_FOR_TRADE_AND_FINANCE       
	...
	public void testHBTF() throws InterruptedException, IOException {
		...
		do {			
			try {
				...
				System.out.println("Counter= "+ counter);
				System.out.println("Value of i1= "+ i1);
				assistant.VostroCheckCompare(driver,partnerName,HBTF_XPATH,HBTF_thres,HBTF_Near_thres);
...
//=========================================================================================================================================    
//V.SLOW  //#13:ICICI_ICICI_Bank_Ltd.                                           
	...
	public void testICICI() throws InterruptedException, IOException {
		...
		do {			
			try {
				...
				System.out.println("Counter= "+ counter);
				System.out.println("Value of i1= "+ i1);
				assistant.VostroCheckCompare(driver,partnerName,ICICI_XPATH,ICICI_thres,ICICI_Near_thres);
...
//===========================================================================================================================    
//FAST  //#14:IBBL_Islami_Bank_Bangladesh_Limited                
	...
	public void testIBBL() throws InterruptedException, IOException {
		...
		do {			
			try {
				...
				System.out.println("Counter= "+ counter);
				System.out.println("Value of i1= "+ i1);
				assistant.VostroCheckCompare(driver,partnerName,IBBL_XPATH,IBBL_thres,IBBL_Near_thres);
	...
	public void testJBL() throws InterruptedException, IOException {
		...
		do {			
			try {
				...
				System.out.println("Counter= "+ counter);
				System.out.println("Value of i1= "+ i1);
				assistant.VostroCheckCompare(driver,partnerName,JBL_XPATH,JBL_thres,JBL_Near_thres);
...
//===========================================================================================================================
//V.SLOW  //#16:MBTC_Metropolitan_Bank_and_Trust_Company  
	...
	public void testMBTC() throws InterruptedException, IOException {
		...
		String MBTC_NEAR_TO_THRESHOLD=properties.getProperty("MBTC_Near_To_Threshold_Balance");
		Assistant assistant=new Assistant();
		do {
			try {
				counter++;
				System.out.println("Counter= "+ counter);
				System.out.println("Value of i1= "+ i1);
				assistant.VostroCheckCompare2Currency(driver,partnerName111,partnerName211, MBTC_XPATH, MBTC_thres_usd, MBTC_thres_php, MBTC_NEAR_TO_THRESHOLD);
...
//=========================================================================================================================================    
//FAST  //#17:MCB_Muslim_Commercial_Bank_Ltd.                       
	...
	public void testMCB() throws InterruptedException, IOException {
		...
		do {			
			try {
				...
				System.out.println("Counter= "+ counter);
				System.out.println("Value of i1= "+ i1);
				assistant.VostroCheckCompare(driver,partnerName,MCB_XPATH,MCB_thres,MCB_Near_thres);
...
//===========================================================================================================================
//V.SLOW  //#18:BNI_PT_BANK_NEGARA_INDONESIA_TBK                      
	...
	public void testBNI() throws InterruptedException, IOException {
		...
		String BNI_NEAR_TO_THRESHOLD=properties.getProperty("BNI_Near_To_Threshold_Balance");
		Assistant assistant=new Assistant();
		do {
			try {
				counter++;
				System.out.println("Counter= "+ counter);
				System.out.println("Value of i1= "+ i1);
				assistant.VostroCheckCompare2Currency(driver,partnerName111,partnerName211, BNI_XPATH, BNI_thres_usd, BNI_thres_php, BNI_NEAR_TO_THRESHOLD);
...
//===========================================================================================================================    
//FAST BUT FOR 1 CURRENCY	//    #19:PB_Peoples_Bank                                               
	...
	public void testPB() throws InterruptedException, IOException {
		...
		do {			
			try {
				...
				System.out.println("Counter= "+ counter);
				System.out.println("Value of i1= "+ i1);
				assistant.VostroCheckCompare(driver,partnerName,PB_XPATH,PB_thres,PB_Near_thres);
...
//=========================================================================================================================================    
//V.SLOW  //#20:PNB_Philippine_National_Bank             
	...
	public void testPNB() throws InterruptedException, IOException {
		...
		String PNB_NEAR_TO_THRESHOLD=properties.getProperty("PNB_Near_To_Threshold_Balance");
		Assistant assistant=new Assistant();
		do {
			try {
				counter++;
				System.out.println("Counter= "+ counter);
				System.out.println("Value of i1= "+ i1);
				assistant.VostroCheckCompare2Currency(driver,partnerName111,partnerName211, PNB_XPATH, PNB_thres_usd, PNB_thres_php, PNB_NEAR_TO_THRESHOLD);
...
//===========================================================================================================================   
//v.slow  //#21:SAMPATH_SAMPATH_BANK_PLC
	...
	public void testSAMPATH() throws InterruptedException, IOException {
		...
		String SAMPATH_NEAR_TO_THRESHOLD=properties.getProperty("SAMPATH_Near_To_Threshold_Balance");
		Assistant assistant=new Assistant();
		do {
			try {
				counter++;
				System.out.println("Counter= "+ counter);
				System.out.println("Value of i1= "+ i1);
				assistant.VostroCheckCompare2Currency(driver,partnerName111,partnerName211, SAMPATH_XPATH, SAMPATH_thres_usd, SAMPATH_thres_php, SAMPATH_NEAR_TO_THRESHOLD);
	...
	public void testSBL() throws InterruptedException, IOException {
		...
		do {			
			try {
				...
				System.out.println("Counter= "+ counter);
				System.out.println("Value of i1= "+ i1);
				assistant.VostroCheckCompare(driver,partnerName,SBL_XPATH,SBL_thres,SBL_Near_thres);
...
//===========================================================================================================================    
//FAST  //#23:SEBL_SOUTHEAST_BANK_LTD                     
	...
	public void testSEBL() throws InterruptedException, IOException {
		...
		do {			
			try {
				...
				System.out.println("Counter= "+ counter);
				System.out.println("Value of i1= "+ i1);
				assistant.VostroCheckCompare(driver,partnerName,SEBL_XPATH,SEBL_thres,SEBL_Near_thres);
...
//=========================================================================================================================================    
//V.SLOW  //#24:SBI_State_Bank_Of_India                                         
	...
	public void testSBI() throws InterruptedException, IOException {
		...
		do {			
			try {
				...
				System.out.println("Counter= "+ counter);
				System.out.println("Value of i1= "+ i1);
				assistant.VostroCheckCompare(driver,partnerName,SBI_XPATH,SBI_thres,SBI_Near_thres);
...
//===========================================================================================================================        
//FAST  //#25:FBL_THE_FEDERAL_BANK_LIMITED                            
	...
	public void testFBL() throws InterruptedException, IOException {
		...
		do {			
			try {
				...
				System.out.println("Counter= "+ counter);
				System.out.println("Value of i1= "+ i1);
				assistant.VostroCheckCompare(driver,partnerName,FBL_XPATH,FBL_thres,FBL_Near_thres);
...
//=========================================================================================================================================    
//FAST  //#26:UBL_United_Bank_Limited                                 
	...
	public void testUBL() throws InterruptedException, IOException {
		...
		do {			
			try {
				...
				System.out.println("Counter= "+ counter);
				System.out.println("Value of i1= "+ i1);
				assistant.VostroCheckCompare(driver,partnerName,UBL_XPATH,UBL_thres,UBL_Near_thres);
...
//===========================================================================================================================    
//V.SLOW  //#27:BM_PT_BANK_MANDIRI_(PERSERO)_TBK                      
	...
	public void testBM() throws InterruptedException, IOException {
		...
		do {			
			try {
				...
				System.out.println("Counter= "+ counter);
				System.out.println("Value of i1= "+ i1);
				assistant.VostroCheckCompare(driver,partnerName,BM_XPATH,BM_thres,BM_Near_thres);
