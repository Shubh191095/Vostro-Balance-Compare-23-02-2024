...
//	public void testBase2(WebDriver driver) throws InterruptedException, IOException
	@BeforeMethod
	public void setUp()
	{
...
//==================================================================================================================		 
	...
	//==========================================================================================================================================================         
	         ...
	         pw.println(properties.getProperty("AUB-USD"));
	         pw.println(properties.getProperty("AUB-PHP"));
