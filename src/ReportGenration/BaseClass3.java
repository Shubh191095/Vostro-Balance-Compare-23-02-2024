...
public void testBase3(WebDriver driver) throws InterruptedException, IOException
{
...
pw.println("Vostro Balance MAD: " + vostroBalance);
pw.println(properties.getProperty("AJWB-MAD"));
