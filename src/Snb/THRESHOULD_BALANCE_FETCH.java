...
public class THRESHOULD_BALANCE_FETCH {
...
//==================================================================================================================		 
		...
		try {
		    ...
		    // Handle the case where the element is not found (home page not opened)
		    System.out.println("Home page not opened. No screenshot taken.");
		} catch (Exception ex) {
...
//==================================================================================================================       
        ...
        Files.copy(f5, new File("C:\\Users\\Shubham\\Desktop\\New Automation Project Related Docs\\Automation Screenshots\\QuickpaySelect the Partner.jpg"));
